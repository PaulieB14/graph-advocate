...
Open [`/chat`](https://graph-advocate-production.up.railway.app/chat) in your browser and type any onchain question — e.g. *"Top Uniswap V3 pools on Base"* or *"Wallet balance for vitalik.eth"*. No setup, no wallet, no signup.
